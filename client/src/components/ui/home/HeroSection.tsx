...
export default function HeroSection() {
  return(
    <main className="flex items-center justify-center min-h-screen">
      <div className="max-w-4xl mx-auto py-16 px-10 text-center">
        ...
        <div className="mt-6 space-y-4 sm:space-y-2">
          <h1 className="text-4xl lg:text-6xl font-bold">Track Every Job Applications.</h1>
          <h1 className="text-4xl lg:text-6xl font-bold text-indigo-600">Land Your Dream Career.</h1>
          <h1 className="text-4xl lg:text-6xl font-bold">Faster.</h1>
        </div>
        <div className="mt-6 space-y-6 max-w-xl mx-auto">
          <p className="text-gray-500 text-md lg:text-lg">Organize applications, monitor interview progress, set reminders, and never lose track of opportunities again.</p>
        </div>
        <div className="mt-10 flex max-sm:flex-col items-center justify-center gap-4 sm:gap-6">
          <Link to="/auth/register" className="inline-flex items-center gap-2 rounded-xl bg-indigo-600 border border-indigo-600 px-6 py-3 text-white hover:bg-indigo-700 transition-colors duration-300">
            <span className="text-xs lg:text-sm font-bold">Start Tracking Free</span>
            <MoveRight size={16} />
          </Link>
          <Link to="/auth/login" className="border border-gray-300 rounded-xl px-6 py-3 text-gray-700 hover:border-gray-500 transition-colors duration-300">
            <span className="text-xs lg:text-sm font-bold">View Demo</span>
          </Link>
        </div>
      </div>
    </main>
