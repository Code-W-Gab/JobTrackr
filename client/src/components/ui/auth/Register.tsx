      ...
      <div className="w-full max-w-sm">
        ...
        <form className="space-y-4">
          <div>
            ...
            <input type="email" id="email" placeholder="Juan Dela Cruz" className="mt-1.5 block w-full border border-gray-200 rounded-xl py-2 px-3 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"/>
          </div>
          <div>
          ...
          <div>
            ...
            <input type="password" id="password" placeholder="Create a strong password" className="mt-1.5 block w-full border border-gray-200 rounded-xl py-2 px-3 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"/>
          </div>
          <div>
            <label htmlFor="password" className="block text-xs font-medium text-gray-700">Confirm Password</label>
            <input type="password" id="password" placeholder="Confirm your password" className="mt-1.5 block w-full border border-gray-200 rounded-xl py-2 px-3 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"/>
          </div>
